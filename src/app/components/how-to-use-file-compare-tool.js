...
export default function HowToUseTextCompare() {
  ...
  const steps = [
    {
      number: 1,
      title: "Upload Your Original Text File",
      description: "Upload your original text file using insert icon in to the left-side text area. This will be your baseline for comparison.",
      icon: FileText,
      detail: "The left panel accepts any plain text content, including documents, code, articles, or any text you want to compare."
    },
    {
      number: 2,
      title: "Upload Your Compare Text File",
      description: "Upload your compare text file using insert icon in to the right-side text area. This is the modified version you want to check against the original.",
      icon: FileText,
