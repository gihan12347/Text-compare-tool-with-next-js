...
const ImprovedTextareaUIForFile = () => {
  ...
  // ✅ helper to read file and set text
          ...
          <div className="p-6">
            <div className="flex flex-col lg:flex-row gap-6 w-full">
              ...
              <div className="flex-1 lg:flex-[3] space-y-3">
                ...
                <AutoResizeTextarea
                  placeholder="Paste, type, or upload original text..."
                  value={text1}
                  onChange={(e) => setText1(e.target.value)}
                  minRows={4}
                  maxRows={15}
                  className="w-full bg-slate-50 text-slate-900 text-sm px-4 py-4 rounded-xl border border-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              ...
              <div
                onClick={handleSwap}
                className="flex items-center justify-center lg:flex-col flex-row lg:w-auto w-full lg:py-8 py-4 cursor-pointer"
              >
              ...
              <div className="flex-1 lg:flex-[3] space-y-3">
                ...
                <AutoResizeTextarea
                  placeholder="Paste, type, or upload modified text..."
                  value={text2}
                  onChange={(e) => setText2(e.target.value)}
                  minRows={4}
                  maxRows={15}
                  className="w-full bg-slate-50 text-slate-900 text-sm px-4 py-4 rounded-xl border border-slate-200 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
            </div>
...
export default ImprovedTextareaUIForFile;
